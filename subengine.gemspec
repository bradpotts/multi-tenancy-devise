...
Gem::Specification.new do |s|
  ...
  s.description = "CDG subengine-devise gem adds multi-tenant and account management features to rails Devise gem. Plataformatec Devise and required custom Twitter Bootstrap Devise views included. Note for add this to your apps gemfile: gem 'subengine-devise', '~> 1.4.1', require: 'subengine' "
  s.license     = "MIT"
